        ...
        <article>
            ...
            <script>
                ...
                (function() {
                    ...
                    if (uniqueToken)
                        if (location.hash.length > 2) uniqueToken.parentNode.parentNode.parentNode.innerHTML = '<h2 style="text-align:center;display: block;"><a href="' + location.href + '" target="_blank">Only for Shukla Family</a></h2>';
